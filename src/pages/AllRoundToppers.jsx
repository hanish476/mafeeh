  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden min-h-[380px]">
        ...
        ${
          topper.position === 1
            ? "h-50 w-50 text-7xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-amber-200/50"
            : "h-20 w-20 text-sm bg-gradient-to-br from-blue-500 to-indigo-600 shadow-blue-200/50"
        }`}
                    >
            ...
            : "h-6 w-6 text-xs text-white bg-gradient-to-br from-blue-600 to-indigo-700"
                  ...
                  >
                    <h4
                      className={` font-semibold text-slate-800 leading-tight ${
                        topper.position === 1 ? "text-2xl font-semibold mb-1" : "text-lg"
                      }`}
                    >
                      {topper.name}
                    </h4>
                ...
                >
                  <div className="flex flex-wrap gap-2 justify-center">
                    <span className="text-xs px-2.5 py-1.5 bg-blue-50 text-blue-700 rounded flex items-center">
                      <Users className="h-3 w-3 mr-1" />
                      Team {topper.team}
                    </span>
                    <span className="text-xs px-2.5 py-1.5 bg-purple-50 text-purple-700 rounded">
                      Class {topper.class}
                    </span>
                    <span className="text-xs px-2.5 py-1.5 bg-emerald-50 text-emerald-700 rounded">
                      {topper.category}
                    </span>
                  </div>
                </div>
