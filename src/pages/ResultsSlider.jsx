...
export default function ResultsSlider() {
  ...
  const latestResults = useMemo(() => {
    return [...results]
      .filter(r => r.datePublished) // Ensure date exists
      .sort((a, b) => new Date(b.datePublished) - new Date(a.datePublished)) // Newest first
      .slice(0, 10); // Only latest 20
  }, []);
  ...
  if (!filteredResults || filteredResults.length === 0) {
    return (
      <motion.div
        ...
        className=" text-center py-16  rounded-2xl  bg-[#d2bb9a] shadow-xs border border-slate-100/70"
      >
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-50 to-blue-50/30 p-1 shadow-xs">
        ...
        <div className="relative h-full shadow-inner overflow-hidden rounded min-h-[400px]">
          <AnimatePresence custom={direction} initial={false}>
            ...
            >
              <div className="bg-white rounded-2xl shadow-xs  sm:p-6 border border-slate-100/70 h-full">
                {/* Program Header */}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span className="inline-flex  gap-2 items-center px-2 py-1 rounded-full bg-green-50 text-green-700 text-xs sm:text-sm font-medium">
                          <span>Published</span>
